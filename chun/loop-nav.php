	...
	<?php elseif ( is_singular( 'post' ) ) : ?>
		...
		<div class="loop-nav">
			<?php previous_post_link( '%link', '<span class="previous">' . __( '<span class="meta-nav">&larr;</span> Previous', 'chun' ) . '</span>' ); ?>
			<?php next_post_link( '%link', '<span class="next">' . __( 'Next <span class="meta-nav">&rarr;</span>', 'chun' ) . '</span>' ); ?>
		</div><!-- .loop-nav -->
